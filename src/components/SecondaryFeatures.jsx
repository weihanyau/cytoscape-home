...
const features = [
    ...
    },
    {
        ...
        form: (
            <div className="flex w-full justify-center">
                <LinkButton href="https://web-stage.cytoscape.org/">Go to Cytoscape Web</LinkButton>
            </div>
        ),
    },
    {
        ...
        >
            <Container>
                <div className="mx-auto max-w-2xl sm:text-center">
                    <h2 className="text-3xl font-medium tracking-tight text-gray-900">The Cytoscape ecosystem</h2>
                    <p className="mt-2 text-lg text-gray-600">Make the most of the apps in the Cytoscape ecosystem.</p>
                </div>
                <ul
                    role="list"
